    ...
    <body>
        ...
        <main>
            <div id="divNuevoEnemigo">
                ...
                <form action="nueva_torre.php" method="POST">
                    <label>Nombre de la torre: <input type="text" name="nameTorre"></label> <br><br><br>
                    <label>Radio de actuación: <input type="number" name="radioTorre"></label><br><br><br>
                    <label>Velocidad de recorrido: <input type="number" name="velTorre"></label><br><br><br>
                    <label>Nombre de la imagen: <br><br><input type="file" name="nameImgTorre"></label> <br><br><br>
